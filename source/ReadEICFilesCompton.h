...
//  -*- C++ -*-.
#ifndef G4MAIN_READEICFILESCOMPTON_H
#define G4MAIN_READEICFILESCOMPTON_H
...
class ReadEICFilesCompton : public SubsysReco
{
 public:
  ReadEICFilesCompton(const std::string &name = "EICReader");
  virtual ~ReadEICFilesCompton();
